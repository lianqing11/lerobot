...
from lerobot.datasets.lerobot_dataset import LeRobotDatasetMetadata, MultiLeRobotDatasetMetadata
...
def make_policy(
    ...
    ds_meta: LeRobotDatasetMetadata | MultiLeRobotDatasetMetadata | None = None,
